...
// Assuming you already have a Loader component imported
      ...
      <div className="h-screen flex split-background">
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-md">
            <h1 className="text-6xl font-bold text-center text-white mb-4 poppins-bold">
              ScoreSnag
            </h1>
            <h3 className="text-2xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 poppins-bold">
              Access music anywhere.
            </h3>
            <h5 className="text-md font-normal text-center poppins-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">
            ...
            <TextField
              ...
              sx={{
                '& label': { color: 'white', fontFamily: 'Poppins, sans-serif' },
          ...
          {loading && (
            <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <Loader /> {/* Call the Loader component */}
            </div>
          )}
        </div>
      </div>
